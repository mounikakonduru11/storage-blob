...
var SDK_VERSION = "12.0.0-preview.3";
...
var DefaultStorageScope = "https://storage.azure.com/.default";
var URLConstants = {
    Parameters: {
...
function sanitizeHeaders(originalHeader) {
    var headers = new coreHttp.HttpHeaders();
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.log(coreHttp.HttpPipelineLogLevel.INFO, "==> OUTGOING REQUEST (Try number=" + this.tryCount + "):");
                        this.log(coreHttp.HttpPipelineLogLevel.INFO, "  " + request.method + ": " + sanitizeURL(request.url));
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                    ...
                    case 2:
                        ...
                        currentLevel = coreHttp.HttpPipelineLogLevel.INFO;
                        logMessage = "";
                        if (this.shouldLog(coreHttp.HttpPipelineLogLevel.INFO)) {
                        ...
                        if (requestCompletionTime >= this.loggingOptions.logWarningIfTryOverThreshold) {
                            ...
                            if (this.shouldLog(coreHttp.HttpPipelineLogLevel.WARNING)) {
                                currentLevel = coreHttp.HttpPipelineLogLevel.WARNING;
                        ...
                        if ((response.status >= 400 &&
                            ...
                            currentLevel = coreHttp.HttpPipelineLogLevel.ERROR;
                        }
                        ...
                        this.log(coreHttp.HttpPipelineLogLevel.INFO, "  request headers: " + JSON.stringify(sanitizeHeaders(response.request.headers), null, 2));
                        this.log(coreHttp.HttpPipelineLogLevel.INFO, "  response headers: " + JSON.stringify(sanitizeHeaders(response.headers), null, 2));
                        return [2 /*return*/, response];
                    case 3:
                        err_1 = _a.sent();
                        if (err_1 instanceof coreHttp.RestError && err_1.request) {
                            this.log(coreHttp.HttpPipelineLogLevel.INFO, "  request headers: " + JSON.stringify(sanitizeHeaders(err_1.request.headers), null, 2));
                        }
                        this.log(coreHttp.HttpPipelineLogLevel.ERROR, "Unexpected failure attempting to make request. Error message: " + err_1.message);
                        throw err_1;
...
var RETRY_ABORT_ERROR = new coreHttp.RestError("The request was aborted", coreHttp.RestError.REQUEST_ABORTED_ERROR);
/**
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                if (!request.headers.contains(HeaderConstants.X_MS_CLIENT_REQUEST_ID)) {
                    request.headers.set(HeaderConstants.X_MS_CLIENT_REQUEST_ID, coreHttp.generateUuid());
                }
                return [2 /*return*/, this._nextPolicy.sendRequest(request)];
            });
        });
...
function newPipeline(credential, pipelineOptions) {
    ...
    ];
    {
        ...
        if (typeof pipelineOptions.proxy === "string") {
            proxySettings = coreHttp.getDefaultProxySettings(pipelineOptions.proxy);
        }
        else {
            proxySettings = pipelineOptions.proxy;
        }
        factories.push(coreHttp.proxyPolicy(proxySettings));
    }
    factories.push(coreHttp.isTokenCredential(credential)
        ? coreHttp.bearerTokenAuthenticationPolicy(credential, DefaultStorageScope)
        : credential);
...
var StorageClient = /** @class */ (function () {
    ...
    function StorageClient(url, pipeline) {
        ...
        for (var _i = 0, _a = this.pipeline.factories; _i < _a.length; _i++) {
            var factory = _a[_i];
            if ((coreHttp.isNode && factory instanceof SharedKeyCredential) ||
...
// Copyright (c) Microsoft Corporation. All rights reserved.
var ABORT_ERROR = new coreHttp.RestError("The request was aborted", coreHttp.RestError.REQUEST_ABORTED_ERROR);
/**
 * ONLY AVAILABLE IN NODE.JS RUNTIME.
 *
...
var BlobClient = /** @class */ (function (_super) {
    ...
    function BlobClient(urlOrConnectionString, credentialOrPipelineOrContainerName, blobNameOrOptions, options) {
        ...
        else if ((coreHttp.isNode && credentialOrPipelineOrContainerName instanceof SharedKeyCredential) ||
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.blobContext.download({
                                ...
                                onDownloadProgress: coreHttp.isNode ? undefined : options.progress,
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        blockList = [];
                        blockIDPrefix = coreHttp.generateUuid();
                        transferProgress = 0;
                        batch = new Batch(options.parallelism);
                        _loop_1 = function (i) {
                            batch.addOperation(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
var PageBlobClient = /** @class */ (function (_super) {
    tslib_1.__extends(PageBlobClient, _super);
...
var BlobServiceClient = /** @class */ (function (_super) {
    ...
    function BlobServiceClient(url, credentialOrPipeline, options) {
        ...
        else if ((coreHttp.isNode && credentialOrPipeline instanceof SharedKeyCredential) ||
                ...
                switch (_a.label) {
                    case 0:
                        if (typeof urlOrBlobClient === "string" &&
                            ((coreHttp.isNode && credentialOrOptions instanceof SharedKeyCredential) ||
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (typeof urlOrBlobClient === "string" &&
                            ((coreHttp.isNode && credentialOrTier instanceof SharedKeyCredential) ||
...
Object.defineProperty(exports, 'HttpPipelineLogLevel', {
    enumerable: true,
    get: function () {
        return coreHttp.HttpPipelineLogLevel;
    }
});
